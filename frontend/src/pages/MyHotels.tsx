    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 gap-8">
        {hotelData.map((hotel: HotelType) => (
          <div className="flex flex-col justify-between border border-slate-300 rounded-lg p-8" key={hotel._id}>
            ...
            <span className="flex justify-end">
              <Link
                ...
                className="flex bg-blue-600 text-white text-l font-bold p-2 hover:bg-blue-500 mt-4"
              >
                View Details
              </Link>
            </span>
